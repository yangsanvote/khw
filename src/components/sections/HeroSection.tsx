...
export default function HeroSection() {
  return (
    <section className="h-screen snap-start relative flex flex-col items-center justify-center bg-white text-gray-900 overflow-hidden px-4 py-8">
      {/* 네 귀퉁이 삼각형 - 최하위 레이어 */}
      ...
      <div className="w-full max-w-6xl mx-auto">
        <motion.div
          ...
          className="flex flex-col items-center z-10 mt-[4vh] md:mt-0 lg:mt-[2vh] xl:mt-[4vh] 2xl:mt-[6vh] px-4"
        >
          {/* 메인 텍스트 */}
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
